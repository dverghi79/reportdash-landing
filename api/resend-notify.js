// resend-notify.js — ReportDash LP
// Required env vars: RESEND_API_KEY, RESEND_FROM_EMAIL, CONTACT_EMAIL
// RESEND_SEGMENT_ID defaults to the ReportDash waitlist segment if not overridden.

const PRODUCT_SEGMENT_ID = '598a8495-29ef-440d-a53a-e3b481bbfaed'; // Waitlist-ReportDash
...
module.exports = async function handler(req, res) {
  ...
  const productName = product || 'ReportDash';
